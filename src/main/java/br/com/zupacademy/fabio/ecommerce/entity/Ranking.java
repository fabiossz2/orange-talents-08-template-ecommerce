...
public class Ranking implements EventoCompraSucesso {
    ...
    public boolean processa(Compra compra) {
        ...
        mapCompra.put("idVendedor", compra.getComprador().getId());
        String json = gson.toJson(mapCompra);
        ResponseEntity<String> exchange = new RestTemplate()
                .exchange(urlRanking, HttpMethod.POST, new HttpEntity<String>(json, headers), String.class);
